...
- **4 slash commands**: `/new-feature`, `/resume`, `/checkpoint`, `/update` (kit upgrade)
...
Already using opencode-kit? Paste this into **any** AI agent. The agent will detect your current version, fetch the migration changelog, apply any breaking changes, re-render templates, and update your manifest — all in one session.
